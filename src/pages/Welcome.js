  ...
  render() {
    ...
    const front = (
      <div style={{textDecoration: 'none', color: 'black'}} className="entry--front">
        <div className="entry--front--title">
    ...
    return (
      <div className="puzzlelist">
        {this.state.puzzleList
          .slice()
          .reverse()
          .filter((entry) => entry.info && entry.info.type === type)
          .map((entry, i) => (
        ...
        <div className="welcome--main">
          <div className="welcome--browse">
            <div className="welcome--browse--filter">
              <div className="welcome--browse--filter--header">Difficulty</div>
              {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'All'].map(
                (day, i) => (
                  <div key={i} className="welcome--browse--filter--option">
                    <input type="checkbox" />
                    <label>{day}</label>
                  </div>
                )
            ...
            <div className="welcome--browse--puzzlelist--wrapper">
              <div className="welcome--browse--puzzlelist dailies">
                <div className="welcome--browse--title">Daily Puzzles</div>
                {this.renderPuzzleList('Daily Puzzle')}
              </div>

              <div className="welcome--browse--puzzlelist minis">
                <div className="welcome--browse--title">Mini Puzzles</div>
